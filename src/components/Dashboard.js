            ...
            return (
                <div>
                    ...
                    <div style={styles.cardsContainer}>
                        ...
                        <button
                            style={{...styles.card, ...styles.disabledCard}} // Keeping disabled for now
                        ...
                        {/* Manage Coupons - ENABLED and linked to new route */}
                        <button
                            style={styles.card} // Changed from disabledCard
                            onClick={() => handleCardClick('/admin/coupons')} // New route for coupons
                            onMouseOver={(e) => {
                                e.currentTarget.style.transform = styles.cardHover.transform; // Changed to cardHover
                                e.currentTarget.style.boxShadow = styles.cardHover.boxShadow; // Changed to cardHover
                            }}
                            onMouseOut={(e) => {
                                e.currentTarget.style.transform = 'none';
                                e.currentTarget.style.boxShadow = styles.card.boxShadow;
